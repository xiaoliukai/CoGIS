...
void CoCDC::DrawLine(CoPnt PointStart,CoPnt PointEnd,CoLinePro LinePro)
{
	...
	// 	Point1.x = int(PointStart.x);
	// 	Point1.y = int(PointStart.y);
	// 	Point2.x = int(PointEnd.x);
	// 	Point2.y = int(PointEnd.y);
	dc.MoveTo(Point1);
	dc.LineTo(Point2);
...
void CoCDC::DrawPolygon(vector<CoPnt>& Poly,CoPolyPro PolyPro)
{
	...
	for(int i=0;i<PolyNum;i++)
	{
		...
		// 		PointArray[i].x = int(Poly[i].x);
		// 		PointArray[i].y = int(Poly[i].y);
	}
...
void CoCDC::DrawRect(CoPnt Point1,CoPnt point2,CoPolyPro PolyPro)
{
	...
	// 	MyPoint1.x = int(Point1.x);
	// 	MyPoint1.y = int(Point1.y);
	// 	MyPoint2.x = int(point2.x);
	// 	MyPoint2.y = int(point2.y);
...
void CoCDC::DrawCirclePnt(CoPnt Point,CoPntPro PntPro)
{
	...
	// 	Point1.x = int(Point.x-PntPro.PntRadio);
	// 	Point1.y = int(Point.y+PntPro.PntRadio);
	// 	Point2.x = int(Point.x+PntPro.PntRadio);
	// 	Point2.y = int(Point.y-PntPro.PntRadio);
...
void CoCDC::XDrawTrianglePnt(CoPnt Point,CoPntPro PntPro)
{
	...
	DPtoVP(Point.x-radio/2,Point.y,&MyArray[1].x,&MyArray[1].y);
	DPtoVP(Point.x+radio/2,Point.y,&MyArray[2].x,&MyArray[2].y);
	// 	MyArray[0].x = int(Point.x - r1);
	// 	MyArray[0].y = int(Point.y + PntPro.PntRadio/2);
	//  MyArray[1].x = int(Point.x + r1);
	// 	MyArray[1].y = int(Point.y + PntPro.PntRadio/2);
	// 	MyArray[2].x = int(Point.x);
	// 	MyArray[2].y = int(Point.y - PntPro.PntRadio);
	dc.Polygon(MyArray,3);
	dc.SelectObject(OldPen);
	dc.SelectObject(OldBrush);
}
